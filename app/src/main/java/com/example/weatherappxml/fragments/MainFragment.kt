...
import com.example.weatherappxml.Constance
import com.example.weatherappxml.DialogManager
...
class MainFragment : Fragment() {
    ...
    private fun initViewPager2Adapter() = with(binding) {
        val adapter = VpAdapter(activity as FragmentActivity, fList)
        vp.adapter = adapter
        TabLayoutMediator(tabLayout, vp) { tab, pos ->
            tab.text = resources.getStringArray(R.array.titles)[pos]
        }.attach()
